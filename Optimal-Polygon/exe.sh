...
./main -edge_selection 3 -initialization 1b -polygonInit incremental -i testcases/test1.txt -o results/test1.txt -L 1 -threshold 1000 -max -algorithm simulated_annealing
